<template>
  <div class="container mx-auto my-16">
      ...
      <h3 class="text-3xl"><strong>Introduction</strong></h3>


      <p>
      Welcome to cal.pv.dev.
      </p>
      <p>
      cal.pv.dev (“us”, “we”, or “our”) operates https://cal.pv.dev (hereinafter referred to as “Service”).
      </p>
      <p>
      Our Privacy Policy governs your visit to https://cal.pv.dev, and explains how we collect, safeguard and disclose information that results from your use of our Service.
      </p>
      <p>
      ...
      <h3 class="text-3xl"><strong>Definitions</strong></h3>


      <p>
      SERVICE means the https://cal.pv.dev website operated by cal.pv.dev.
      </p>
      <p>
      ...
      <h3 class="text-3xl"><strong>Information Collection and Use</strong></h3>
      ...
      <p>
      We may use your Personal Data to contact you with newsletters, marketing or promotional materials and other information that may be of interest to you. You may opt out of receiving any, or all, of these communications from us by following the unsubscribe link or by emailing at support@cal.pv.dev.
      </p>
      <p>
      Usage Data
      </p>
      ...
      <h3 class="text-3xl"><strong>Use of Data</strong></h3>


      <p>
      cal.pv.dev uses the collected data for various purposes:
      </p>
      <ul>
      ...
      <h3 class="text-3xl"><strong>Retention of Data</strong></h3>
      ...
      <h3 class="text-3xl"><strong>Transfer of Data</strong></h3>
      ...
      <p>
      cal.pv.dev will take all the steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organisation or a country unless there are adequate controls in place including the security of your data and other personal information.
      </p>
      <h3 class="text-3xl"><strong>Disclosure of Data</strong></h3>
      ...
      <h3 class="text-3xl"><strong>Security of Data</strong></h3>


      <p>
      The security of your data is important to us but remember that no method of transmission over the Internet or method of electronic storage is 100% secure. While we strive to use commercially acceptable means to protect your Personal Data, we cannot guarantee its absolute security.
      </p>
      <h3 class="text-3xl"><strong>Your Data Protection Rights Under General Data Protection Regulation (GDPR)</strong></h3>
      ...
      <p>
      If you wish to be informed what Personal Data we hold about you and if you want it to be removed from our systems, please email us at support@cal.pv.dev.
      </p>
      <p>
      ...
      <h3 class="text-3xl"><strong>Your Data Protection Rights under the California Privacy Protection Act (CalOPPA)</strong></h3>
      ...
      <li>users are able to change their personal information by emailing us at support@cal.pv.dev.
      </li>
      </ul>
      <p>
      ...
      <h3 class="text-3xl"><strong>Your Data Protection Rights under the California Consumer Privacy Act (CCPA)</strong></h3>
      ...
      <p>
      By email: support@cal.pv.dev
      </p>
      <p>
      Your data protection rights, described above, are covered by the CCPA, short for the California Consumer Privacy Act. To find out more, visit the official California Legislative Information website. The CCPA took effect on 01/01/2020.
      </p>
      <h3 class="text-3xl"><strong>Service Providers</strong></h3>
      ...
      <h3 class="text-3xl"><strong>Analytics</strong></h3>
      ...
      <h3 class="text-3xl"><strong>CI/CD tools</strong></h3>
      ...
      <h3 class="text-3xl"><strong>Payments</strong></h3>
      ...
      <h5><strong>Stripe:</strong></h5>


      <p>
      Their Privacy Policy can be viewed at: https://stripe.com/us/privacy
      </p>
      <h3 class="text-3xl"><strong>Links to Other Sites</strong></h3>
      ...
      <h3 class="text-3xl"><strong>Children's Privacy</strong></h3>
      ...
      <h3 class="text-3xl"><strong>Changes to This Privacy Policy</strong></h3>
      ...
      <h3 class="text-3xl"><strong>Contact Us</strong></h3>
